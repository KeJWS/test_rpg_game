...
class Shop_event(Event):
    def __init__(self, name, encounter_text, enter_text, exit_text, item_set) -> None:
        super().__init__(name, 100)
...
class Healing_event(Event):
    def __init__(self, name, encounter_text, success_text, fail_text, success_chance, healing_amount) -> None:
