...
quest_fight_against_slime = quest.Quest("史莱姆之王", text.quest_fight_against_slime_text, text.shop_fight_against_slime_text, 100, 100, items.long_bow, fight_against_slime_combat, 7)
